...
| clientName | Agent client type (`claude-code`, `codex`, `copilot-cli`, `qoder`, `qoder-ide`, `qoderwork`, `qwenworkcn`, `qoder_<source>_<ide>`, `vscode`) |
...
| clientName | Agent 客户端类型（`claude-code`、`codex`、`copilot-cli`、`qoder`、`qoder-ide`、`qoderwork`、`qwenworkcn`、`qoder_<source>_<ide>`、`vscode`） |
